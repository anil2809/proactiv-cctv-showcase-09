    ...
    <div className="relative w-full max-w-5xl mx-auto rounded-xl overflow-hidden bg-background/30 backdrop-blur-lg">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent">
        <div className="max-w-2xl mx-auto text-center">
          <h3 className="text-xl font-bold dark:text-white light:text-black mb-2">Worldwide Remote Monitoring</h3>
          <p className="text-sm dark:text-white/70 light:text-gray-700">
